    ...
    <>
      ...
      <Stack gap={2} justifyContent='center' display='flex'>
        ...
        <Stack 
          ...
          marginBottom={4} 
          flexWrap='wrap' >
          <img src={EagleLogo} alt='Eagle Welding Logo' height={100} width={300}/>
          <Stack>
          <Typography variant="h4">Where Metal Meets Craftsmanship</Typography>
          <Typography variant="h6"><em>Your Local Mobile Welding Service, Monroe PA</em></Typography>
        ...
        <Stack direction='row' justifyContent='center' alignItems='center' flexWrap='wrap' margin='auto'>
        <Stack marginRight={12}>
          <Typography variant="h4" maxWidth={500} marginBottom={2}>Mobile Welding Repairs and Custom Fabrication</Typography>
          ...
          <Typography maxWidth={600} marginBottom={2}>
          <strong>Contact us today for an estaimate on your project!</strong>
          </Typography>
          <Typography maxWidth={600}>
          <strong>Call: 570-212-9595  |  Email: dan@eaglewelds.com</strong>
          </Typography>
            </Stack>
          <img src={DanWelding} alt='Dan grinding a part for a project' height={400} width={300} />
        </Stack>
