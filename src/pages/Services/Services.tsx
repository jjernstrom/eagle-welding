...
const services = [
  {
    ...
    description:
      "Professional mobile welding services brought directly to your location. Our fully equipped mobile unit allows us to perform high-quality welding services anywhere in Monroe County.",
    icon: BuildIcon,
    processes: [
      "SMAW (Stick)",
      "GTAW (TIG)",
  ...
  },
  {
    ...
    description:
      "Transform your ideas into reality with our custom metal fabrication services. From architectural elements to industrial components, we bring your vision to life.",
  ...
  },
  {
    ...
    description:
      "Expert welding solutions for all types of vehicles. Whether it's classic car restoration or modern repairs, we ensure precision and reliability in every project.",
  ...
  },
  {
    ...
    description:
      "Specialized repair and restoration services for decorative metalwork, architectural elements, and metal art pieces. We bring damaged or weathered pieces back to their original beauty.",
    icon: HandymanIcon,
    specialties: [
      ...
      <Container maxWidth="lg">
        <Stack spacing={6}>
          <Box textAlign="center">
            ...
            >
              From mobile welding to custom fabrication, we provide expert
              welding solutions tailored to your specific needs. Quality
