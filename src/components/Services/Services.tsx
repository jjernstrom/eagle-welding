...
const services = [
  ...
  },
  {
    ...
    description:
      "Expert welding solutions for all types of vehicles. From classic car restoration to modern repairs, we ensure precision and reliability.",
  ...
  },
  {
    ...
    description:
      "Specialized in repairing and restoring decorative metalwork, railings, sculptures, and architectural elements. Professional restoration of metal art pieces.",
    icon: HandymanIcon,
    image: eagleWorking,
  },
];
